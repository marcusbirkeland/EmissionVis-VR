...
namespace Editor.CloudsSpawner
{
    public class CloudSpawner
    {
        ...
        public CloudSpawner(string jsonDataPath, string attributesFilePath, string cdfFilePath, GameObject map, string cloudPrefabName, string cloudManagerPrefabName, float rotationAngle)
        {
